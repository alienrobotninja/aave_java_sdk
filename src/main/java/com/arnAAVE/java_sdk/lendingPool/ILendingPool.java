...
public class ILendingPool extends Contract {
    ...
    public List<ReserveDataUpdatedEventResponse> getReserveDataUpdatedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(RESERVEDATAUPDATED_EVENT, transactionReceipt);
    ...
    public Flowable<ReserveDataUpdatedEventResponse> reserveDataUpdatedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, ReserveDataUpdatedEventResponse>() {
            @Override
            public ReserveDataUpdatedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(RESERVEDATAUPDATED_EVENT, log);
                ReserveDataUpdatedEventResponse typedResponse = new ReserveDataUpdatedEventResponse();
                typedResponse.log = log;
                typedResponse.reserve = (String) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.liquidityRate = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public RemoteFunctionCall<String> getAddressesProvider() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETADDRESSESPROVIDER,
                Arrays.<Type>asList(),
    ...
    public RemoteFunctionCall<ReserveConfigurationMap> getConfiguration(String asset) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETCONFIGURATION,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, asset)),
    ...
    public RemoteFunctionCall<BigInteger> getReserveNormalizedVariableDebt(String asset) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETRESERVENORMALIZEDVARIABLEDEBT,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, asset)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<List> getReservesList() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETRESERVESLIST,
                Arrays.<Type>asList(),
    ...
    public RemoteFunctionCall<UserConfigurationMap> getUserConfiguration(String user) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETUSERCONFIGURATION,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, user)),
